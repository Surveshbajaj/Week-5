...
public class MergeJsonfFile {
    public static void main(String[] args) {
        ...
        try {
            // Read JSON files
            JsonNode json1 = objectMapper.readTree(new File("C:\\Users\\sarve\\Desktop\\Week 5 pr\\Day_2\\src\\main\\java\\com\\handsonproblem\\mergetwojsonfile\\file1.json"));
            JsonNode json2 = objectMapper.readTree(new File("C:\\Users\\sarve\\Desktop\\Week 5 pr\\Day_2\\src\\main\\java\\com\\handsonproblem\\mergetwojsonfile\\file2.json"));
